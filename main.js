...
eval("const addProject = document.getElementById(\"add-project\");\n\naddProject.addEventListener(\"click\", () =>{\n    const createProject = document.createElement(\"div\");\n    createProject.classList.add(\"create-project-div\");\n    createProject.innerHTML = `\n    <h2>Create Project</h2>\n    <form action=\"#\" method=\"get\">\n        <label for=\"title\">Title</label>\n        <input id=\"title\" type=\"text\" name=\"title\" placeholder=\"Enter the title of your project\">\n    </form>\n    <button class=\"create-project\">Add</button> <button class=\"cancel-project\">Cancel</button>\n    `;\n\n    const main = document.querySelector(\"#main\");\n    main.appendChild(createProject);\n\n})\n\n//# sourceURL=webpack://todo-list/./src/project.js?");
